...
public class OAuthAttributes {
    ...
    // of() = OAuth2User에서 반환하는 사용자 정보는 Map이기 때문에 값 하나하나를 반환해야해서 of 사용
    ...
    // OAuthAttirbutes에서 엔티티를 생성하는 시점은 처음 가입할 때
    // 가입할 때의 기본 권한을 GUEST로 주기 위해서 role 빌더값에는 Role.GUEST를 사용..
    // OAuthAttibutes클래스 생성이 끝났으면 같은 패키지에 SessionUser 클래스를 생성합니다.
